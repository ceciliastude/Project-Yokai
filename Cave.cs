...
namespace Project_Yokai
{
    public class Cave : GameScreen
    {
        ...
        public Cave(Game game, Player player) : base(game)
        {
        ...
        public override void LoadContent()
        {
            ...
            backgroundSprite = Content.Load<Texture2D>("Assets/Backgrounds/Map6");
            ...
            audioManager.LoadContent(Content, "SFX/smooth-cold-wind-looped-135538");
